...
CREATE TABLE entryTypes (description VARCHAR (256) NOT NULL, id INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY, isContainer SMALLINT NOT NULL, name VARCHAR (64) NOT NULL, namePlural VARCHAR (66), sortBy INTEGER, PRIMARY KEY (id))
;
