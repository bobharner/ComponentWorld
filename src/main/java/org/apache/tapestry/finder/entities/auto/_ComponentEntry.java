...
/**
 * Class _ComponentEntry was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _ComponentEntry extends CayenneDataObject {
    ...
    public void addToChildren(ComponentEntry obj) {
        addToManyTarget("children", obj, true);
    }
    public void removeFromChildren(ComponentEntry obj) {
        removeToManyTarget("children", obj, true);
    }
    @SuppressWarnings("unchecked")
    public List<ComponentEntry> getChildren() {
        return (List<ComponentEntry>)readProperty("children");
    }
    ...
    public void setParent(ComponentEntry parent) {
        setToOneTarget("parent", parent, true);
    }

    public ComponentEntry getParent() {
        return (ComponentEntry)readProperty("parent");
    }
